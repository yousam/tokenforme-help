...
3. Distribute the corresponding keys to team members and tell them to use the API base URL configured as described in the "API base URLs" section of the "Overview" chapter.
...
3. Configure each internal system (OpenClaw instances, internal bots, CI/CD scripts, etc.) to use the API base URL described in the "API base URLs" section of the "Overview" chapter and the appropriate key.
...
2. Provide participants with simple connection instructions:
   - Base URL: see the "API base URLs" section in the "Overview" chapter for the appropriate endpoint.
