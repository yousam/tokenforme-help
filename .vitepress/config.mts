    ...
    sidebar: {
      '/zh/': [
        ...
        },
        {
          text: '模型与报价',
          items: [
            { text: '可用模型列表', link: '/zh/models' },
            { text: '模型价格', link: '/zh/model-pricing' }
          ]
        },
        {
          text: '与智能体集成',
	    ...
	    { text: 'Continue 插件', link: '/zh/integrations.agents#continue_plugin' },
      ...
      '/en/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Model Pricing', link: '/en/model-pricing' }
          ]
        },
        {
          text: 'Integrations',
	    ...
	    { text: 'Continue plugin', link: '/en/integrations.agents#continue_plugin' },
        ...
        },
        {
          ...
          items: [
            { text: 'Balance API', link: '/en/api-integration/balance' },
            { text: 'Available Models API', link: '/en/api-integration/models' }
          ]
        },
        {
